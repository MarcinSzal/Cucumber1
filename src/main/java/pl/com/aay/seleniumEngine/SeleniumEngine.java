...
public class SeleniumEngine {
	...
	public WebElement getElement (String lp){
		return driver.findElement(By.xpath("(//ul[@id='homefeatured']/descendant::img)["+lp+"]"));
	}

	public WebElement getElement (String lp, String xpath){
		return driver.findElement(By.xpath("(//ul[@id='homefeatured']/descendant::img)["+lp+"]"));
	}
